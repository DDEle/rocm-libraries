...
namespace
{
    ...
    // (mod 256) per field. A macro-order entry that lands on the wrong real offset
    // desyncs this from what Arguments::validate() checks against arg.NAME.
